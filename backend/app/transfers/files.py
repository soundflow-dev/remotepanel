...
TRANSFER_CHUNK_SIZE = _positive_int_env("TRANSFER_CHUNK_SIZE", 32 * 1024 * 1024, 1024 * 1024, 256 * 1024 * 1024)
TRANSFER_PREFETCH_CHUNKS = _positive_int_env("TRANSFER_PREFETCH_CHUNKS", 12, 1, 16)
TRANSFER_PARALLEL_FILES = _positive_int_env("TRANSFER_PARALLEL_FILES", 2, 1, 16)
TRANSFER_FILE_STREAMS = _positive_int_env("TRANSFER_FILE_STREAMS", 12, 1, 16)
