...
TRANSFER_CHUNK_SIZE = _positive_int_env("TRANSFER_CHUNK_SIZE", 8 * 1024 * 1024, 1024 * 1024, 256 * 1024 * 1024)
...
TRANSFER_FILE_STREAMS = _positive_int_env("TRANSFER_FILE_STREAMS", 2, 1, 16)
